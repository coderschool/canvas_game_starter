...
let bgReady, dinoReady, eggReady, bombReady;
let bgImage, dinoImage, eggImage, bombImage;
...
function loadImages() {
  ...
  bombImage = new Image(); //create new Img Element
...
let update = function() {
  ...
  if (
    ...
    bombX = Math.floor(Math.random() * 480);
    bombY = Math.floor(Math.random() * 380);
  }
};
